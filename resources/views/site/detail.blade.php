@extends('site.master')
@section('titel','ProductDetail |'.env('APP_NAME'))
@section('nav')
<nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 1;">
@endsection
@section('content')

   @include('site.part.header',['titel'=>'ProductDetail','name'=>'ProductDetail'])
    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{ asset('image/product/'.$product->image) }}" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 pb-5">
                ...
                <p class="mb-4">{!! Str::words( $product->description,5) !!}</p>
